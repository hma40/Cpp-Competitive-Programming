...
signed main() {
    ...
    while(t--) {
        ...
        if(min(xb,xc)>=xa) {
            if(min(yb,yc)>=ya) {
                cout << min(xb,xc)-xa+min(yb,yc)-ya+1 << endl;
            } else if(max(yb,yc)<=ya) {
                cout << min(xb,xc)-xa+ya-max(yb,yc)+1 << endl;
            } else {
                cout << min(xb,xc)-xa+1 << endl;
            }
        } else if(max(xb,xc)<=xa) {
            if(min(yb,yc)>=ya) {
                cout << -max(xb,xc)+xa+min(yb,yc)-ya+1 << endl;
            } else if(max(yb,yc)<=ya) {
                cout << -max(xb,xc)+xa+ya-max(yb,yc)+1 << endl;
            } else {
                cout << -max(xb,xc)+xa+1 << endl;
            }
        } else {
            if(min(yb,yc)>=ya) {
                cout << min(yb,yc)-ya+1 << endl;
            } else if(max(yb,yc)<=ya) {
                cout << ya-max(yb,yc)+1 << endl;
            } else {
                cout << 1 << endl;
            }
        }
